...
const EXT_FORMAT: string[] = ['avif', 'jpeg', 'jpg', 'png', 'raw', 'tiff', 'webp']
...
function validate(body: Record<string, unknown>, keys: Record<string, TypeSpec>): { error?: string } {
...
function parse(body: Record<string, unknown>, keys: Record<string, TypeSpec>): Record<string, unknown> {
